...
const hikeList = [
  ...
  },
  {
    ...
    comments: ' "this is comment three" ',
  },
];
// Hike Model
class HikeModel {
    ...
    // commmentmodel incomplete 
    // commentModel(){
    //   return hikeList.forEach(hike =>hike.comments === comments);
    // }
  }
